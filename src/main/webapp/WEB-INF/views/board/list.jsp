...
<spring:eval var="jsApiKey" expression="@property['kakaoJsApiKey']" />
...
<script type="text/javascript">
	...
	function mapView(data) {
		...
		var iwContent = '<div style="padding:5px;">${member.memName}</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
